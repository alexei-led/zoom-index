...
This is a sample template for zoom-index - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name zoom-index --query 'Stacks[].Outputs'
```
